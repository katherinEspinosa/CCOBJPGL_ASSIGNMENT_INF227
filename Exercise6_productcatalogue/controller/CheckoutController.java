...
public class CheckoutController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        name4.setText(HomeController.slamp.getProductName());
        price4.setText(Double.toString(HomeController.slamp.getProductPrice()));
        Image smallLamp = new Image(HomeController.slamp.getProductImage());
        img4.setImage(smallLamp);
        ...
        if (HomeController.clamp.getProductStatus() || HomeController.blamp.getProductStatus() || HomeController.wlamp.getProductStatus()) {
            ...
            + Double.parseDouble(choicebox4.getValue()) * HomeController.slamp.getProductPrice();
    ...
    public void computeTotal(ActionEvent event) {
        ...
        if (HomeController.slamp.getProductStatus()) {
