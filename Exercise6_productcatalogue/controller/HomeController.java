...
public class HomeController implements Initializable {
    ...
    static StudyLamp slamp = new StudyLamp();
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        // ============== STUDY LAMP ==================//
        slamp.setProductName("Study Lamp");
        name4.setText(slamp.getProductName());

        slamp.setProductPrice(25.00);
        price4.setText(Double.toString(slamp.getProductPrice()));

        slamp.setProductImage("images/lamp4.jpg");
        Image smallLamp = new Image(slamp.getProductImage());
